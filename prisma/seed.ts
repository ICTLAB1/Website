...
async function main() {
  ...
  const topicFaqs: Array<{ topic: string; question: string; answer: string }> = [
    { topic: "enterprise", question: "Can you supply multiple brands on one purchase order?", answer: "Yes. That is the core of what we do: one itemised quotation covering several publishers and hardware manufacturers, one purchase order, and one GST invoice." },
    ...
    { topic: "enterprise", question: "How long does a quotation take?", answer: "Standard software licensing quotations are typically returned within one business day. Configured hardware and multi-brand solutions depend on the publisher's or manufacturer's response and are given a stated turnaround when the enquiry is acknowledged." },
