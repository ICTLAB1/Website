...
const SHAPES: Record<BlockType, string> = {
  ...
  LOGO_MARQUEE: `{ "eyebrow"?, "heading"?, "description"?, "source"?: "withLogo" | "all" | "manual" | "clients", "slugs"?: ["…"], "limit"?, "speed"?: "slow" | "steady" | "brisk", "reverse"?: false, "layout"?: "belt" | "wall", "desaturate"?: false, "action"?: { "label", "href" } }  — the marks are read from each brand's logo, never named here; "clients" reads Customer logos instead, and shows only rows with a confirmed permission`,
  INDUSTRY_GRID: `{ "eyebrow"?, "heading"?, "description"?, "filterable"?: true, "limit"?, "action"?: { "label", "href" } }  — the sectors come from Industries, not from here`,
