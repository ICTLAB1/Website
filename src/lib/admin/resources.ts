...
export const RESOURCES: Record<ResourceKey, ResourceConfig> = {
  brands: {
    ...
    description: "Vendors whose licensing you supply. Each has a public brand page.",
    guard: "admin",
    slugField: "slug",
    softDelete: true,
    ...
    fields: [
      ...
      { kind: "text", name: "website", label: "Vendor website", maxLength: 300, group: "Presentation" },
  ...
  categories: {
    ...
    fields: [
      ...
      { kind: "relation", name: "brandId", label: "Brand", resource: "brand", hint: "Only for categories specific to one vendor.", group: "Identity" },
